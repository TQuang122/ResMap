          ...
          <svg width="100%" height="100%" xmlns="http://www.w3.org/2000/svg">
            <defs>
              <pattern id="neural" width="80" height="80" patternUnits="userSpaceOnUse">
                ...
                {/* Connections */}
                <line x1="10" y1="10" x2="40" y2="30" stroke="#F36F21" stroke-width="0.5" opacity="0.3"/>
                <line x1="40" y1="30" x2="70" y2="15" stroke="#F36F21" stroke-width="0.5" opacity="0.3"/>
                <line x1="10" y1="10" x2="20" y2="50" stroke="#F36F21" stroke-width="0.5" opacity="0.2"/>
                <line x1="20" y1="50" x2="55" y2="55" stroke="#F36F21" stroke-width="0.5" opacity="0.3"/>
                <line x1="55" y1="55" x2="75" y2="60" stroke="#F36F21" stroke-width="0.5" opacity="0.3"/>
                <line x1="20" y1="50" x2="5" y2="75" stroke="#F36F21" stroke-width="0.5" opacity="0.2"/>
                <line x1="5" y1="75" x2="35" y2="70" stroke="#F36F21" stroke-width="0.5" opacity="0.3"/>
                <line x1="35" y1="70" x2="65" y2="80" stroke="#F36F21" stroke-width="0.5" opacity="0.3"/>
              </pattern>
            </defs>

...
interface ResExplorePanelProps {
  lecturer: LecturerData;
  isExpanded: boolean;
  onToggle: () => void;
}

const ResExplorePanel: React.FC<ResExplorePanelProps> = ({ lecturer, isExpanded, onToggle }) => {
  return (
    <div
          ...
          <div className="pt-4 space-y-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
              ...
              <div className="flex items-center gap-2">
                ...
                <a href={`mailto:${lecturer.email}`} className="text-blue-600 hover:underline" onClick={(e) => e.stopPropagation()}>
                  {lecturer.email}
                </a>
              </div>
            </div>
...
export default ResExplorePanel;

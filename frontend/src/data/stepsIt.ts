    ...
    guidance: [
      ...
      },
      {
        ...
        subSteps: [
          ...
          'N|Conference vs Journal|Conference: Công bố tại hội nghị, thường 3-4 ngày, peer review ngắn hơn, nhanh chóng cập nhật xu hướng mới. Phù hợp với Computer Science, Engineering. Journal: Công bố trên tạp chí, peer review kỹ lưỡng hơn, thời gian xuất bản dài hơn. Phù hợp với các ngành cần nghiên cứu sâu như Sciences, Social Sciences.',

    ...
    guidance: [
      {
        ...
        resExploreBox: {
          title: 'Design ResExplore',
          description: 'Khám phá giảng viên Thiết kế tại FPTU để tìm mentor phù hợp cho đề tài của bạn.',
          buttonLabel: 'Mở Design ResExplore'
        }
      },
      {
        id: 'step1_g2',
  ...
  },
  {
    ...
    guidance: [
      ...
      },
      {
        ...
        subSteps: [
          'N|Nguồn tìm kiếm|• Google Scholar: Tổng hợp từ mọi nguồn học thuật, miễn phí\n• ACM Digital Library: Design, HCI, Interactive Technologies\n• Scopus: Thuộc Elsevier, phủ sóng rộng Arts, Design, Humanities\n• Web of Science: Thuộc Clarivate, index các tạp chí uy tín nhất\n• Springer Nature: Design research, Arts and Humanities\n• Wiley Online Library: Visual Arts, Design Studies\n• JSTOR: Arts, Design, Architecture history và theory',
          'N|Conference vs Journal|Conference: Công bố tại hội nghị, thường 3-4 ngày, peer review ngắn hơn. Phù hợp với Design khi cần showcase prototypes và nhận feedback nhanh từ cộng đồng. Journal: Công bố trên tạp chí, peer review kỹ lưỡng hơn. Phù hợp với nghiên cứu lý thuyết, phân tích sâu về design.',
          'N|Conference Ranking|A*: Hội nghị elite trong Design & HCI, acceptance rate 5-15%\nA: Hội nghị top-tier, well-known trong lĩnh vực, acceptance rate 15-25%\nB: Hội nghị tốt, solid venues, acceptance rate 25-35%\nC: Hội nghị chấp nhận được, bổ sung cho danh mục, acceptance rate 35-50%',
